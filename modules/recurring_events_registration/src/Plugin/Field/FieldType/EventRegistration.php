...
class EventRegistration extends DateRangeItem {
  ...
  public function isEmpty() {
    ...
    $max_seats = $this->get('max_seats')->getValue();
    ...
    return parent::isEmpty() && empty($registration) && empty($registration_type)
      ...
      && empty($permitted_roles) && empty($max_seats);
  }
  ...
  public static function propertyDefinitions(FieldStorageDefinitionInterface $field_definition) {
    ...
    $properties['max_seats'] = DataDefinition::create('integer')
      ->setLabel(t('Max Seats'))
